...
adminRouter.get('/my-profile/:adminId',  viewAdminProfile) /**To view user profile */
adminRouter.put('/:adminId', updateAdminProfile) /**To update details in existing profile */
